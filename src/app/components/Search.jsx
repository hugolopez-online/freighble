        ...
        <form className="border rounded-3 p-3 text-bg-light" onSubmit={handleSpecs}>
            ...
            <div className="row mb-2">
                <div className="col-12">
                    ...
                    <select className="form-select" id="mode" value={formData.mode} onChange={(e) => setFormData((prev) => {return ({...prev, mode: e.target.value})})} required>
            ...
            <fieldset className="row mb-2">
                ...
                <div className="input-group col-12">
                    <input type="text" className="form-control col-8" placeholder="City (optional)" id="originCity" name="originCity" value={formData.originCity} onChange={(e) => setFormData((prev) => {return ({...prev, originCity: e.target.value})})} />
                    <select className="form-select col-4" id="originState" name="originState" value={formData.originState} onChange={(e) => setFormData((prev) => {return ({...prev, originState: e.target.value})})} required>
            ...
            <fieldset className="row mb-2">
                ...
                <div className="input-group col-12">
                    <input type="text" className="form-control col-8" placeholder="City (optional)" id="destinationCity" name="destinationCity" value={formData.destinationCity} onChange={(e) => setFormData((prev) => {return ({...prev, destinationCity: e.target.value})})} />
                    <select className="form-select col-4" id="destinationState" name="destinationState" value={formData.destinationState} onChange={(e) => setFormData((prev) => {return ({...prev, destinationState: e.target.value})})} required>
                        <option value="" style={{display: "none"}}>State/Province</option>
                        <option disabled>Canada</option>
                        {canDivisions.map((state, index) => {
                            return (
            ...
            <div className="row mb-2">
                <div className="col-12">
                    ...
                    <select className="form-select" id="borderPort" value={formData.border} onChange={(e) => setFormData((prev) => {return ({...prev, border: e.target.value})})} required>
            ...
            <fieldset className="row mb-2">
                ...
                <div className="col-12">
                    <div className="form-check form-check-inline">
                        <input className="form-check-input" type="checkbox" id="hazmat" name="hazmat" checked={formData.hazmat} onChange={(e) => setFormData((prev) => {return ({...prev, hazmat: e.target.checked})})} />
                        <label className="form-check-label" htmlFor="hazmat">Hazmat</label>
                    </div>
                    <div className="form-check form-check-inline">
                        <input className="form-check-input" type="checkbox" id="teamDrivers" name="teamDrivers" checked={formData.team} onChange={(e) => setFormData((prev) => {return ({...prev, team: e.target.checked})})} />
                        <label className="form-check-label" htmlFor="teamDrivers">Team Drivers</label>
                    </div>
                    <div className="form-check form-check-inline">
                        <input className="form-check-input" type="checkbox" id="usBonded" name="usBonded" checked={formData.usbond} onChange={(e) => setFormData((prev) => {return ({...prev, usbond: e.target.checked})})} />
                        <label className="form-check-label" htmlFor="usBonded">U.S. Bonded</label>
                    </div>
                    <div className="form-check form-check-inline">
                        <input className="form-check-input" type="checkbox" id="canadaBonded" name="canadaBonded" checked={formData.canadabond} onChange={(e) => setFormData((prev) => {return ({...prev, canadabond: e.target.checked})})} />
